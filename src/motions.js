...
(function (root) {
  ...
  M.register({
    ...
    keys: [
      ...
      { t: 0.5, d: { 'pelvis.y': 0.918, 'pelvis.pitch': 7, 'neck.flex': -3 } },
      { t: 1.3, d: { 'pelvis.y': 0.799, 'pelvis.pitch': 14, 'neck.flex': -6 } },
      { t: 2.2, d: { 'pelvis.y': 0.624, 'pelvis.pitch': 22, 'neck.flex': -10 } },
      { t: 3.5, hold: true, d: { 'pelvis.y': 0.412, 'pelvis.pitch': 30, 'spineT.flex': 5, 'neck.flex': -14 } },
      { t: 4.1, hold: true, d: { 'pelvis.y': 0.412, 'pelvis.pitch': 30, 'spineT.flex': 5, 'neck.flex': -14 } },
      { t: 4.6, d: { 'pelvis.y': 0.637, 'pelvis.pitch': 26, 'neck.flex': -11 } },
      { t: 5.0, d: { 'pelvis.y': 0.849, 'pelvis.pitch': 12, 'neck.flex': -5 } },
  ...
  M.register({
    ...
    hands: { L: { at: [0.54, 0.45, -0.31], local: HAND.palmSurf, align: 'surface', normal: [0, -1, 0],
    ...
    base: {
      ...
      'thighL.flex': 100, 'thighL.abd': -7, 'thighL.rot': 5, 'shankL.flex': 128,
  ...
  M.register({
    ...
    keys: [
      { t: 0.0, hold: true, d: { footPitch: 22, 'toesR.flex': -22, 'toesL.flex': -22, 'pelvis.y': 1.085 } },
      { t: 0.6, d: { footPitch: 8, 'toesR.flex': -8, 'toesL.flex': -8, 'pelvis.y': 1.112 } },
      { t: 1.6, hold: true, d: { footPitch: -36, 'toesR.flex': 36, 'toesL.flex': 36, 'pelvis.y': 1.219 } },
      { t: 3.6, hold: true, d: { footPitch: -36, 'toesR.flex': 36, 'toesL.flex': 36, 'pelvis.y': 1.219 } },
      { t: 4.8, d: { footPitch: -6, 'toesR.flex': 6, 'toesL.flex': 6, 'pelvis.y': 1.138 } },
      { t: 6.6, hold: true, d: { footPitch: 22, 'toesR.flex': -22, 'toesL.flex': -22, 'pelvis.y': 1.085 } }
    ]
  });
