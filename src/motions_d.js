...
(function (root) {
  ...
  M.register({
    ...
    hands: {
      R: { at: { bone: 'pelvis', local: [0.03, 0.13, 0.085] }, local: HAND.palm, pitch: 60, yaw: -30, pole: [-0.87, -0.5, 0.15] },
      L: { at: { bone: 'pelvis', local: [0.03, 0.13, -0.085] }, local: HAND.palm, pitch: 60, yaw: 30, pole: [-0.87, -0.5, -0.15] }
    },
